...
<template>
	<section class="my-8 mx-4">
		<div
			class="mt-8 p-6 bg-white rounded-2xl shadow-md max-w-xl mx-auto w-full"
		>
			...
			<form
				...
				class="flex flex-col gap-4 max-w-xl w-full mx-auto"
			>
				<!-- Title -->
				<input
					type="text"
				...
				<input
					...
					@input="
						emit('update:estimatedPomodoros', $event.target.value)
					"
